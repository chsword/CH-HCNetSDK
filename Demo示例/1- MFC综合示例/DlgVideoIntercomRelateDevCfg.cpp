...
void CDlgVideoIntercomRelateDevCfg::CheckRaidoBtn()
{
    ...
    GetDlgItem(IDC_EDIT_MANAGE_UINT_IP)->EnableWindow(m_nUnitType == ENUM_INDOOR_UINT || m_nUnitType == ENUM_OUTDOOR_UINT  || m_nUnitType == ENUM_FENCE_UINT|| m_nUnitType == ENUM_VILLA_OUTDOOR_UNIT);
    GetDlgItem(IDC_EDIT_OUTDOOR_UNIT_IP)->EnableWindow(m_nUnitType == ENUM_INDOOR_UINT || m_nUnitType == ENUM_OUTDOOR_UINT  || m_nUnitType == ENUM_FENCE_UINT|| m_nUnitType == ENUM_VILLA_OUTDOOR_UNIT);
    GetDlgItem(IDC_EDIT_SIP_SERVER_IP)->EnableWindow(m_nUnitType == ENUM_INDOOR_UINT || m_nUnitType == ENUM_OUTDOOR_UINT || m_nUnitType == ENUM_MANAGE_UINT  || m_nUnitType == ENUM_FENCE_UINT|| m_nUnitType == ENUM_VILLA_OUTDOOR_UNIT|| m_nUnitType == ENUM_AGAIN_UNIT);
    GetDlgItem(IDC_EDIT_AGAIN_IPADDR)->EnableWindow(m_nUnitType == ENUM_INDOOR_UINT);
...
{   
    ...
    m_strSIPServerIP = "";
    m_struIndoorUnit = "";
    if (m_nUnitType == ENUM_OUTDOOR_UINT  || m_nUnitType == ENUM_FENCE_UINT)
    {
