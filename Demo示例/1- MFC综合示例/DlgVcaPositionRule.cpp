...
// 	{
        ...
        {
            if (ENUM_VCA_EVENT_COMBINED_RULE == wEventTypeEx)
            {
...
//         memcpy(m_struRuleCfgV42.struRule[i].byRuleName,m_struRuleCfg.struRule[i].byRuleName, NAME_LEN);
//         memcpy(&m_struRuleCfgV42.struRule[i].uEventParam,&m_struRuleCfg.struRule[i].uEventParam, sizeof(NET_VCA_EVENT_UNION));
//         memcpy(&m_struRuleCfgV42.struRule[i].struSizeFilter,&m_struRuleCfg.struRule[i].struSizeFilter, sizeof(NET_VCA_SIZE_FILTER));
//         memcpy(&m_struRuleCfgV42.struRule[i].struFilterStrategy,&m_struRuleCfg.struRule[i].struFilterStrategy, sizeof(NET_VCA_EVENT_UNION));
//         memcpy(&m_struRuleCfgV42.struRule[i].struTriggerParam,&m_struRuleCfg.struRule[i].struTriggerParam, sizeof(NET_VCA_EVENT_UNION));
//         memcpy(&m_struRuleCfgV42.struRule[i].struAlarmTime,&m_struRuleCfg.struRule[i].struAlarmTime, sizeof(NET_DVR_SCHEDTIME) * MAX_DAYS *MAX_TIMESEGMENT_V30);
//         
//         m_struRuleCfgV42.struRule[i].struAlarmHandleType.dwHandleType  = m_struRuleCfg.struRule[i].struHandleType.dwHandleType;
//         memset(m_struRuleCfgV42.struRule[i].struAlarmHandleType.dwRelAlarmOut, 0xff, sizeof(DWORD)*MAX_CHANNUM_V30);
//         
//         for (j = 0; j<  MAX_ALARMOUT_V30 && m_struRuleCfgV42.struRule[i].struAlarmHandleType.dwRelAlarmOutChanNum < MAX_CHANNUM_V30; j++)
//         {
//             if (m_struRuleCfg.struRule[i].struHandleType.byRelAlarmOut[j] == 1)
//             {
//                  m_struRuleCfgV42.struRule[i].struAlarmHandleType.dwRelAlarmOut[m_struRuleCfgV42.struRule[i].struAlarmHandleType.dwRelAlarmOutChanNum] = j+1;
//                  m_struRuleCfgV42.struRule[i].struAlarmHandleType.dwRelAlarmOutChanNum ++;
//             }
//         }
//         
//         memset(m_struRuleCfgV42.struRule[i].dwRelRecordChan, 0xff, sizeof(DWORD)*MAX_CHANNUM_V30);
//         dwRelIndex = 0;
//         for (j = 0; j< MAX_CHANNUM_V30  ; j++)
//         {
//             if (m_struRuleCfg.struRule[i].byRelRecordChan[j] == 1 )
//             {
//                  m_struRuleCfgV42.struRule[i].dwRelRecordChan[dwRelIndex++] = j+1; 
//                  
//             }           
//         }
    }
