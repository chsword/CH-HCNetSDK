...
public:
    ...
    NET_DVR_HOLIDAY_HANDLE m_struHideHolidayHandle;
//	BOOL	m_bAlarmOut[MAX_ALARMOUT_V30];
    BOOL	*m_pbAlarmOut;
	BOOL	TimeTest();
	void	CreateTree(void);
    BOOL    GetHideHolidayHandle(NET_DVR_HOLIDAY_HANDLE &struHolidayHandle);
    BOOL    SetHideHolidayHandle(NET_DVR_HOLIDAY_HANDLE &struHolidayHandle);
};
