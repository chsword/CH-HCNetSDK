...
BOOL CDlgPdcRuleCfgEx::PreTranslateMessage(MSG* pMsg) 
{
    ...
    {
    case WM_LBUTTONDOWN:
        if ((m_iDrawType == 1 || m_iDrawType == 2 || m_iDrawType == 3 || m_iDrawType == 4 || m_iDrawType == 5) && (GetAsyncKeyState(VK_LCONTROL)<0 || GetAsyncKeyState(VK_RCONTROL)<0))//按CTRL键 画图
        {
    ...
    case WM_MOUSEMOVE:
        if ((m_iDrawType == 1 || m_iDrawType == 2 || m_iDrawType == 3 || m_iDrawType == 4 || m_iDrawType == 5) && (GetAsyncKeyState(VK_LCONTROL)<0 || GetAsyncKeyState(VK_RCONTROL)<0))
        {
            if (m_iDrawType == 1)
            {
                if(PtInRect(&rcWnd,pt))
        ...
        break;
    case WM_LBUTTONUP:
        if ((m_iDrawType == 1 || m_iDrawType == 4 || m_iDrawType == 5) && (GetAsyncKeyState(VK_LCONTROL)<0 || GetAsyncKeyState(VK_RCONTROL)<0))
        {
            if (m_iDrawType == 4)
            {
                m_struPdcRuleCfg.struAutoCalibPolygon.struPos[1].fX = m_struPdcRuleCfg.struAutoCalibPolygon.struPos[0].fX /*(float)(pt.x-m_rcWnd.left)/(float)m_rcWnd.Width()*/;
...
void CDlgPdcRuleCfgEx::GetPdcRuleWnd()
{
    ...
    m_bLightStream = m_struPdcRuleCfg.byLightStreamEnabled;
...
void CDlgPdcRuleCfgEx::OnBtnPdcRulecfg() 
{
    ...
    m_struPdcRuleCfg.byLightStreamEnabled = m_bLightStream;
