...
void CDlgRemoteIPAccess::OnBtnAddIPChan() 
{
	...
	if (m_comboStreamType.GetCurSel() == 0)
	{
		...
		{ 
            ...
            memcpy(m_struIPParaCfgV40.struIPDevInfo[m_iCurChanIndex].sUserName, m_ceDevUserName.GetBuffer(0), NAME_LEN);
            memcpy(m_struIPParaCfgV40.struIPDevInfo[m_iCurChanIndex].sPassword, m_csDevPwd.GetBuffer(0), PASSWD_LEN);
