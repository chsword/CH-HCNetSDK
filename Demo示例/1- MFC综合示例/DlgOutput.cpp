...
void CDlgOutput::OnMenuShowOSD()
{
    ...
    DWORD dwPRIDATA_RENDER = PLAYM4_RENDER_ANA_INTEL_DATA | PLAYM4_RENDER_MD | PLAYM4_RENDER_ADD_POS | PLAYM4_RENDER_ADD_PIC | PLAYM4_RENDER_FIRE_DETCET | PLAYM4_RENDER_TEM;
    if (!m_bShowOSD)
    {
        if (lPlayerPort > -1)
        {
            ...
            dwPRIDATA_RENDER = PLAYM4_FIRE_FRAME_DIS | PLAYM4_FIRE_MAX_TEMP | PLAYM4_FIRE_MAX_TEMP_POSITION | PLAYM4_FIRE_DISTANCE;
            PlayM4_RenderPrivateDataEx(lPlayerPort, PLAYM4_RENDER_FIRE_DETCET, dwPRIDATA_RENDER, TRUE);
            dwPRIDATA_RENDER = PLAYM4_TEM_REGION_BOX | PLAYM4_TEM_REGION_LINE | PLAYM4_TEM_REGION_POINT;
            PlayM4_RenderPrivateDataEx(lPlayerPort, PLAYM4_RENDER_TEM, dwPRIDATA_RENDER, TRUE);
            m_bShowOSD = TRUE;
        }
        else
        {
