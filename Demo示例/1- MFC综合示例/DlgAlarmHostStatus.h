...
public:
    ...
    NET_DVR_ALARMHOST_MAIN_STATUS_V40   m_struAlarmMainStatus;
    NET_DVR_ALARMHOST_OTHER_STATUS_V50  m_struAlarmOtherStatus;

    NET_DVR_ALARMIN_SETUP m_struAlarmInSetup;
public :
    void InitWnd();

    BOOL GetAlarmHostMainStatus(NET_DVR_ALARMHOST_MAIN_STATUS_V40& struAlarmMainStatus);
    BOOL GetAlarmHostOtherStatus(NET_DVR_ALARMHOST_OTHER_STATUS_V50& struAlarmOtherStatus);

    void SetAlarmHostMainStatusToWnd(NET_DVR_ALARMHOST_MAIN_STATUS_V40& struAlarmMainStatus);
    void SetAlarmHostOtherStatusToWnd(NET_DVR_ALARMHOST_OTHER_STATUS_V50& struAlarmOtherStatus);
